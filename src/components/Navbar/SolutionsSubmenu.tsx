...
const SolutionsSubmenu = ({ setIsOpen }: SolutionsSubmenuProps) => {
  return (
    <div
      ...
      className="hidden lg:block absolute z-100 top-[5.5rem] right-0 bg-white w-[100vw] shadow-t-md text-gray-900 shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px]
      ...
      <div className="flex justify-center wrapper_container gap-5">
        {SOLUTIONS_MENU.subMenu.map((menu) => (
          <div
            ...
            className="border-r-[1px]  pr-12 border-gray-200 last:border-none last:pr-0"
          >
