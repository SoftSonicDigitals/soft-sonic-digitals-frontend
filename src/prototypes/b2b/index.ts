...
export const B2B_DIGITAL_ECOMMERCE_INFO: B2BDigitalEcommerceInfo = {
  ...
  videoLink: "https://www.youtube.com/embed/hCCpvsfmiGI",
  infoArray: [
    {
      title: "B2B Digital Commerce",
      description:
        "Experience the ultimate flexibility with our customized and integrated B2B eCommerce platform, tailored to your B2B, D2C, and Omnichannel commerce requirements. Trust Magneto IT Solutions for seamless decoupling or microservices integration.",
    },
    {
      title: "B2B Marketplace Solutions",
      description:
        "Empower your wholesale business with our robust multi-vendor B2B marketplace solutions. Connect buyers and sellers, streamline operations, and maximize your dealer network's potential for unrivaled competitiveness.",
    },
  ],
};
...
export const B2B_PORTAL_LIST = [
  ...
  },
  {
    ...
    description:
      "With our B2B order management portal solution, you can accelerate the order fulfilment procedure and enhance CX. Through your order management portal, you can keep track of client orders, manage all your customer and order information in one dashboard, fulfil orders according to your own timetables, create invoices and customizable estimates, and split orders into numerous shipments.",
  },
  {
