export const PETZONE = {
  ...
  bannerImg1Path: "/case_study_pages/powerlook/bannerImg1.webp",
  theAsk:
  ...
  showCaseImg1Path: "/case_study_pages/powerlook/showCaseImg1.webp",
  solution:
  ...
  showCaseImg2Path: "/case_study_pages/powerlook/showCaseImg2.webp",
  benefits: [
    "We consulted the Powerlook team to conduct code auditing of their website to understand the code quality.",
    "Complete Code was revamped and functionalities were improved to increase the performance of the website.",
    "We added a return management module which helped the management to track the returned goods and decrease the manual work for them.",
    "Extra extensions and plug-ins that were not used which increased the loading time of the website were removed.",
    "Backend structure was improved to ease out the admin efforts and improve the customer experience.",
  ],
  factsFigures:
  ...
  showCaseImg3Path: "/case_study_pages/powerlook/showCaseImg3.webp",
  bannerImg2Path: "/case_study_pages/powerlook/bannerImg2.webp",
  responsiveLayout:
  ...
  responsiveShowCaseImgPath:
    "/case_study_pages/powerlook/responsive_layout.webp",
  takeAway:
